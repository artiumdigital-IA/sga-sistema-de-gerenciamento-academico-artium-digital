    ...
    <div style={{ padding: '24px 28px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          ...
          <p style={{ margin: '2px 0 0', fontSize: 12, color: 'var(--gray-500)' }}>{candidatos.length} candidato{candidatos.length !== 1 ? 's' : ''}</p>
        </div>
      ...
      {!loading && filtered.length === 0 && <p style={{ color: 'var(--gray-500)', fontSize: 13 }}>Nenhum candidato encontrado.</p>}
